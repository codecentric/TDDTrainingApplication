...
/**
 * Development bean contains errors that need
 *
 ...
 * Time: 12:38
 */
public class TriangleCalculatorServiceDevelopmentBean implements TriangleCalculatorService {

    private static final Pattern NUMBERPATTERN = Pattern.compile("-?\\d+");
    private static final Integer MAXTRIANGLESIZE = new Integer(35);
